...
const getSubCategoriesListNested = async () => {
  const response = await api<Api.Base<any>>('get')('nestedSubCategory')
  return response.data
}

const getSubCategoryDetailByIdNested = async (subCategoryId: string) => {
  console.log(subCategoryId, 'from service subcategoryUd')
  const response = await api<Api.Base<any>>('get')(
...
const updateSubCategoryNested = async (body: any, subCategoryId: string) => {
  const response = await api<Api.Base<{}>>('patch')(
    `/nestedSubCategory/${subCategoryId}`,
    undefined,
    body
...
const deleteSubCategoryNested = async (subCategoryId: string) => {
  const response = await api<any>('delete')(
    `/nestedSubCategory/${subCategoryId}`
  )
}

const createSubCategoryNested = async (body: any) => {
  const response = await api<Api.Base<{}>>('post')(
    `/nestedSubCategory/new`,
    undefined,
    body
  )
  return response.data
...
export const subCategoryService = {
  ...
  createSubCategory,
  updateSubCategory,
  getSubCategoriesListNested,
  getSubCategoryDetailByIdNested,
  deleteSubCategoryNested,
  createSubCategoryNested,
  updateSubCategoryNested
}
